...
class WallpapersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallpaper" do
    assert_difference('Wallpaper.count') do
      post wallpapers_url, params: { wallpaper: { accommodation_id: @wallpaper.accommodation_id, name: @wallpaper.name } }
    end
  ...
  test "should update wallpaper" do
    patch wallpaper_url(@wallpaper), params: { wallpaper: { accommodation_id: @wallpaper.accommodation_id, name: @wallpaper.name } }
